...
class TradingAssistantNLPHandler:
    ...
    async def _call_llm_for_conversation(self, query: str, task_prompt: Optional[str] = None) -> str:
        ...
        base_system_prompt = (
            f"You are 'CryptoNaija Assistant', a highly knowledgeable, friendly, and witty AI specializing in cryptocurrency trading analysis and signals. "
            f"You are proudly based in {location}. Your personality is helpful, encouraging, articulate, and professional, with a touch of appropriate Nigerian flair (e.g., use 'Kedu?', 'Nna men', 'Omo!', 'No wahala' sparingly and naturally if the context fits). "
            f"Your core functions are: providing trading signals, performing detailed market analysis (technical indicators, candlestick patterns, sentiment, macroeconomic factors, and anomaly detection). "
    ...
    async def _handle_predict_price(self, symbol_for_module: Optional[str]) -> str:
        ...
        try:
            ...
            if image_path:
                ...
                image_url = f"http://127.0.0.1:8001/{image_path.replace(os.path.sep, '/')}"
